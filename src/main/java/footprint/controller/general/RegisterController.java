...
public class RegisterController {
	...
	public String authOtp(@ModelAttribute("customer") Customer customer, HttpSession session, ModelMap model,
			@RequestParam("otp-1") String otp1, @RequestParam("otp-2") String otp2, @RequestParam("otp-3") String otp3,
			@RequestParam("otp-4") String otp4, @RequestParam("otp-5") String otp5,
			@RequestParam("otp-6") String otp6) {
