...
<div class="container-fluid p-5 bg-white shadow-lg"
	...
	<c:if test="${ not empty result }">
		<c:choose>
			<c:when test="${result == true }">
				<div class="alert alert-success alert-dismissible shadow mt-4"
					role="alert">
			...
			<c:otherwise>
				<div class="alert alert-danger alert-dismissible shadow mt-4"
					style="border-radius: none" role="alert">
	...
	<form:form method="POST" modelAttribute="product">
		...
		<div class="d-flex flex-column gap-2 justify-content-center h-100">
			...
			<div class="row mt-2">
				...
				<div class="col-6">
					...
					<form:select path="category.idCategory" class="ct-input"
						items="${categorys}" itemLabel="name" itemValue="idCategory"></form:select>
				</div>
			</div>
		...
		<button type="submit"
			...
			style="background-color: #87b106 !important">Lưu sản phẩm</button>
	</form:form>
