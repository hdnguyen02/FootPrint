...
<div class="fixed-top">
	...
	<div style="background-color: #282828 !important;">
		<nav class="navbar navbar-expand-lg container py-2" data-bs-theme="dark">
		<div class="container-fluid position-relative">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 220px">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex gap-4">
					 <li class="nav-item">
				      ...
				      <li class="nav-item">
				          <a class="nav-link active text-uppercase" aria-current="page" href="#">product</a>
				      </li>
				       <li class="nav-item">
				          <a class="nav-link active text-uppercase" aria-current="page" href="#">blog</a>
				      </li>
				      <li class="nav-item">
