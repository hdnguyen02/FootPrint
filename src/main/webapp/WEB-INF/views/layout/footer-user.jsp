...
<div style="background-color: #1a1a1a;">
	...
	<div class="row mt-5 text-white border-top pt-5 gy-3" style="border-color: #696969 !important;">
		...
		<div class="col-12 col-md-6 col-lg-3 text-center d-flex flex-column">
			...
			<div class="d-flex flex-column gap-2 mt-2" style="color: #696969;">
				<span>Ứng tuyển</span>
				<span>Liên hệ nhường quyền</span>
				<span>Về FootPrint</span>
				<span>Nhân sự</span>
			</div>
		...
		<div class="col-12 col-md-6 col-lg-3 text-center d-flex flex-column">
			<h3>Liên hệ</h3>
			<div class="d-flex flex-column gap-2 mt-2" style="color: #696969;">
				<span>Email đóng góp</span>
				<span>Hostline</span>
				<span>0963 429 749</span>
